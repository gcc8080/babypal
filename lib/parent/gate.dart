...
///
/// **放左上角，不要放右下角。** 第一版放在右下，真机上大人按不动：
/// 全屏沉浸（`immersiveSticky`）加上手势导航，屏幕底边那一条是系统的，
/// 手指落在那里先被系统拿去唤出导航栏，App 根本收不到 pointer down。
/// 而这个入口只有 44dp、又贴着边角，几乎整个都落在那条带子里。
///
/// 它「又小又不起眼」这一点在这里反过来咬了一口：目标本来就小，再放进
/// 系统手势区，就成了一个看得见按不着的东西。左上角没有这个问题。
///
/// 顺带一提，**按一下本来就不该有反应**——必须按满 3 秒。
